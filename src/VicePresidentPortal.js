...
import { IconButton, Box, DialogTitle, Dialog, DialogContent, DialogContentText, DialogActions, Menu, Tooltip, MenuItem, ListItemIcon, } from '@mui/material';
...
export default function VicePresidentPortal() {
