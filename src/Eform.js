...
const SubTabs = ({ subTabData, selectedTab, selectedSubTab, updateSelectedTabs, tabLabels, subTabsData }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch(`${BASE_URL}/EmpoyeeDataKPIPost`, {
                method: 'POST',
                headers: {
    ...
    useEffect(() => {
        ...
        const getApiUrl = `${BASE_URL}/SaveEmpoyeeDataKPIGet/${empId}`;
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (checkResponse.ok) {
                ...
                const updateApiUrl = `${BASE_URL}/SaveEmpoyeeDataKPIUpdate/${empId}`;
                ...
                const postApiUrl = `${BASE_URL}/SaveEmpoyeeDataKPIPost`;
    ...
    const clearData = async () => {
        ...
        try {
            ...
            const deleteApiUrl = `${BASE_URL}/SaveEmpoyeeDataKPIDelete/${empId}`;
    ...
    return (
        <div>
            ...
            <Box>
                <TableContainer component={Paper} className='empformTablecontaner' style={{height:'45vh'}}>
                    <Table>
                        <TableHead>
                            <TableRow>
                                <TableCell style={{ fontSize: "100%", fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important',textAlign:'center' }}>Metric</TableCell>
                                <TableCell style={{ fontSize: "100%", fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important',textAlign:'center' }}>Quantity Target</TableCell>
                                <TableCell style={{ fontSize: "100%", fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important',textAlign:'center' }}>Quantity Achieved</TableCell>
                                <TableCell style={{ fontSize: "100%", fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important',textAlign:'center' }}>Comments</TableCell>
                                <TableCell style={{ fontSize: "100%", fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important',textAlign:'center' }}>Index KPI</TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
...
const TabsView = () => {
    ...
    xhr.open("GET", `${BASE_URL}/AdminEmployeeGet`, false);
    xhr.send();
