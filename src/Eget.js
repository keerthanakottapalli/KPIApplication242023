                    ...
                    <div className="sub-tabs" >
                        ...
                        <div className='employeetable'>
                            {loading ? (
                                ...
                                <TableContainer component={Paper} style={{ width: '1150px', height: '44vh', overflow: 'auto' }} >
                                    <Table>
                                        <TableHead>
                                            <TableRow>
                                                <TableCell className='tablecell-style' style={{ fontSize: "100%", fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important', textAlign:'center' }}>Metric</TableCell>
                                        ...
                                        <TableBody>
                                            {tabsData.map((item, index) => (
                                                <TableRow key={index}>
                                                    <TableCell style={{ fontSize: "100%", fontFamily: 'Open Sans,sans-serif!important', textAlign:'center' }}>{item.Metric}</TableCell>
                                                    ...
                                                    <TableCell style={{textAlign:'center'}}>
                                                        <FormControl style={{ width: '70%' }}>
                                                            ...
                                                            <Select
                                                                ...
                                                                onChange={(e) => {handleQuantityAchievedChange(index, e.target.value);
                                                                    handleFieldChange();
                                                                }}
                                                            >
                                      ...
                                      <TableCell style={{textAlign:'center'}}>
                                                    ...
                                                    <TableCell style={{textAlign:'center'}}>
                                                        <FormControl style={{ width: '110%' }}>
                                                            ...
                                                            <Select
                                                                value={item.IndexKpi}
                                                                onChange={(e) => { handleIndexKpiChange(index, e.target.value);
                                                                    handleFieldChange();}}
                                                            >
                                                               {Array.from({ length: 11 }, (_, i) => i).map((number) => (
                                                            <MenuItem key={number} value={number}>
