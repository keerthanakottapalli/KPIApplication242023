...
const [incompleteFields, setIncompleteFields] = useState([]);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch(`${BASE_URL}/ManagerDataKPIPost`, {
                method: 'POST',
                headers: {
    ...
    useEffect(() => {
        ...
        const getApiUrl = `${BASE_URL}/SaveManagerDataKPIGet/${empId}`;
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (checkResponse.ok) {
                ...
                const updateApiUrl = `${BASE_URL}/SaveManagerDataKPIUpdate/${empId}`;
                ...
                const postApiUrl = `${BASE_URL}/SaveManagerDataKPIPost`;
    ...
    const clearData = async () => {
        ...
        try {
            ...
            const deleteApiUrl = `${BASE_URL}/SaveManagerDataKPIDelete/${empId}`;
...
const TabsView = () => {
    ...
    xhr.open("GET", `${BASE_URL}/AdminManagerGet`, false);
    xhr.send();
