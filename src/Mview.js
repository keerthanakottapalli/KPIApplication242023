...
const ButtonCenter = () => {
  ...
  const handleFillFormClick = async () => {
    ...
    try {
      ...
      const response = await fetch(`${BASE_URL}/ManagerAllDataKPIGet`);
      const data = await response.json();
  ...
  return (
    ...
    <>
      ...
      <AppBar position="fixed">
        <Toolbar className="manager-NavBar">
      ...
      {showChangePassword ? (
        ...
        <div style={{ display: 'flex' }}>
          <div style={{
            ...
            <div style={{ alignItems: 'center', }} className="managerbutton-center-container">
              <Button
