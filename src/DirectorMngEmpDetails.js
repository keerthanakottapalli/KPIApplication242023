...
function DirectorUpdateEmpData() {
    ...
    const fetchInitialSections = async () => {
        try {
            const response = await axios.get('http://172.17.15.150:4000/AdminGet');
...
const [isSubmitDisabled, setIsSubmitDisabled] = useState(false)
    ...
    const handleItemClick = async (item) => {
        ...
        try {
            const response = await axios.get(`${BASE_URL}/EmployeeDirectorDataKPIGet/${empId}/${selectedTitle}/${item}`);
            ...
            if (responseData) {
                ...
                try {
                    const newDataResponse = await axios.get(`${BASE_URL}/EmployeeManagerDataKPIGet/${empId}/${selectedTitle}/${item}`);
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            try {
                response = await axios.get(`${BASE_URL}/EmployeeDirectorDataKPIGet/${empId}/${selectedTitle}/${selectedItem}`);
                ...
                try {
                    response = await axios.get(`${BASE_URL}/EmployeeManagerDataKPIGet/${empId}/${selectedTitle}/${selectedItem}`);
                    responseData = response.data.data[0]; // Assuming there's only one item in the array
                } catch (error) {
    ...
    const handleSubmit = async () => {
        ...
        if (selectedItem) {
            ...
            try {
                const response = await axios.post(`${BASE_URL}/EmployeeDirectorDataKPIPost`, JSON.stringify(postData), {
                    headers: {
    ...
    const updateApiData = async (newData) => {
        try {
            const response = await axios.put(
                `${BASE_URL}/EmployeeDirectorDataKPIUpdate/${empId}/${selectedTitle}/${selectedItem}`,
                {
                    Data: newData,
                }
            );
            ...
            OK
                            ...
                            <div className="Dmanager-button">
                                ...
                                <Button
                                    ...
                                    disabled={!isSubmitEnabled || isSubmitDisabled}
                                >
                                    Submit
                                </Button>
                                <Dialog
