...
const Dview = () => {
  ...
  const handleFormFill = () => {
    // Handle Fill KPI Form button click
    navigate(`/dform`); // Navigate to the 'mform' route
  };
  const handleFormGet= () => {
    // Handle Fill KPI Form button click
    navigate(`/dget/${empid}`); // Navigate to the 'mform' route
  };
        ...
        <div style={{ display: 'flex' }}>
          ...
          <div>
            ...
            <Button
              ...
              style={{ backgroundColor: '#0d4166', marginLeft: '10vw', alignItems: 'center', display: 'flex', marginBottom:'10px', width:'190px' }}
            >
              Manager Details
            </Button>
            <Button
            ...
            <Button
              className="managerdetails-button"
              variant="contained"
              onClick={handleFormGet}
              style={{ backgroundColor: '#0d4166', marginLeft: '10vw', alignItems: 'center', display: 'flex',width:'190px' }}
            >
              Director Form Get
            </Button>
