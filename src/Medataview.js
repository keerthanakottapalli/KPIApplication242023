              ...
              {employeesData.some((employee) => reportingManagers[employee.Empid] === username) ? (
                <Table style={{ minWidth: 850 }}>
                  <TableHead style={{ backgroundColor: 'voilet' }}>
                    <TableRow>
                      <TableCell style={{ fontWeight: 'bold', fontSize: '16px', color: '#222', paddingLeft: "10%", textAlign:'center' }}>Employee ID</TableCell>
                      <TableCell style={{ fontWeight: 'bold', fontSize: '16px', color: '#333', paddingLeft: "10%",textAlign:'center'  }}>Employee Name</TableCell>
                      <TableCell style={{ fontWeight: 'bold', fontSize: '16px', color: '#333', paddingLeft: "10%", textAlign:'center' }}>Action</TableCell>
                    </TableRow>
                  </TableHead>
                      ...
                      if (empReportingManager === username) {
                        return (
                          <TableRow key={employee.Empid} style={{ fontWeight: 'bold', color: '#333', paddingLeft: '10%' }}>
                            <TableCell style={{ fontSize: '16px', color: '#333', paddingLeft: '10%', textAlign:'center' }}>{employee.Empid}</TableCell>
                            <TableCell style={{ fontSize: '16px', color: '#333', paddingLeft: '10%',textAlign:'center' }}>{employee.Empname}</TableCell>
                            <TableCell style={{ color: '#333', paddingLeft: '10%', textAlign:'center' }}>
                              <Button
                                variant="contained"
                                color="primary"
                                component={Link}
