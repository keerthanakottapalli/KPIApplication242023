              ...
              <TableCell style={{ color: '#333' }}>
                <div>
                  <Button
                    ...
                    style={{ backgroundColor: '#0d416b', fontWeight: 'bolder', width: '15vw', height: '10vh' }}
                  >
                    Manager KPI's Details
                  </Button>
                  <Button className="employee-details-button" variant="contained"
                    onClick={()=>handleEmpViewDetailsClick(employee.Empname)}

                    style={{ backgroundColor: '#1dbb99', fontWeight: 'bolder', marginLeft: '20px', width: '15vw', height: '10vh' }}
                  >
